...
def config_generators(app):
  ...
  def get_stages():
    stagedata = [ #TODO: finish implementing
      { "id" : 32, "name" : "Final Destination",  "intname": "LAST"      },
      { "id" : 31, "name" : "Battlefield",        "intname": "BATTLE"    },
      { "id" : 28, "name" : "Dream Land",         "intname": "OLD_PPP"   },
      { "id" :  8, "name" : "Yoshi's Story",      "intname": "STORY"     },
      { "id" :  3, "name" : "Pokemon Stadium",    "intname": "PSTADIUM"  },
      { "id" :  2, "name" : "Fountain of Dreams", "intname": "IZUMI"     },
      { "id" : -1, "name" : "Any Stage",          "intname": "_NONE0"    },

      { "id" :  0, "name" : "Dummy",              "intname": "DUMMY"     },
      { "id" :  1, "name" : "Test",               "intname": "TEST"      },
      { "id" :  4, "name" : "Peach's Castle",     "intname": "CASTLE"    },
      { "id" :  5, "name" : "Kongo Jungle",       "intname": "KONGO"     },
      { "id" :  6, "name" : "Brinstar",           "intname": "ZEBES"     },
      { "id" :  7, "name" : "Corneria",           "intname": "CORNERIA"  },
      { "id" :  9, "name" : "Onett",              "intname": "ONETT"     },
      { "id" : 10, "name" : "Mute City",          "intname": "MUTECITY"  },
      { "id" : 11, "name" : "Rainbow Cruise",     "intname": "RCRUISE"   },
      { "id" : 12, "name" : "Jungle Japes",       "intname": "GARDEN"    },
      ...
      { "id" : 20, "name" : "Mushroom Kingdom 2", "intname": "INISHIE2"  },
      { "id" : 21, "name" : "Arcania",            "intname": "AKANEIA"   },
      { "id" : 22, "name" : "Venom",              "intname": "VENOM"     },
      { "id" : 23, "name" : "Poke Floats",        "intname": "PURA"      },
      { "id" : 24, "name" : "Big Blue",           "intname": "BIGBLUE"   },
      { "id" : 25, "name" : "Summit",             "intname": "ICEMT"     },
      { "id" : 26, "name" : "???",                "intname": "ICETOP"    },
      { "id" : 27, "name" : "Flat Zone",          "intname": "FLATZONE"  },
      { "id" : 29, "name" : "Yoshi's Island 64",  "intname": "OLD_YOSH"  },
      { "id" : 30, "name" : "Kongo Jungle 64",    "intname": "OLD_KONG"  },
      ]
